...
class CPUAdmin(admin.ModelAdmin):
    list_display = ('name', 'virtualizationSupported', 'ndbSupported',
                    'coreNumber', 'overallCapacity', 'singleThreadCapacity')
...
class HardwareModelAdmin(admin.ModelAdmin):
    list_display = ('hardwareType', 'name', 'cpu', 'maxNodeNumber',
                    'maxSubscriberSupport', 'vmCapacityRatio', 'reservedCoreNumberForVM',
